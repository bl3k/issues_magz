...
<div class="row">
	<div class="col-xs-12">
    	<br>
		<?= form_open('/admin/news/do_insert', array('id' => 'form', 'role' => 'form', 'class' => 'form-horizontal')); ?>
			<div id="myTabContent" class="tab-content">
				...
				<div class="tab-pane fade" id="second">
					<div style="padding-left: 100px;" class="form-group">
						<textarea name="news_content" id="news_content" class="form-control ckeditor"></textarea>
					</div>          		  
				</div>
			</div>
...
<script type="text/javascript">
	...
	var options = {
		...
		success: function(responseText, statusText, xhr, $form) {
			$.unblockUI();
			loadPage("/admin/news/index", "insert", responseText);
		},
		resetForm: true
	};
