...
<div class="btn-toolbar list-toolbar">
    <button class="btn btn-primary" onclick="loadPage('/admin/site_link/add');"><i class="fa fa-plus"></i> Tambah</button>
...
<table id="grid" class="table table-condensed table-hover table-striped">
	<thead>
		<tr>
			<th data-column-id="site_link_id" data-header-css-class="site_link_id">ID</th>
			<th data-column-id="title" data-header-css-class="title">Judul</th>
			<th data-column-id="url" data-header-css-class="url">Alamat URL</th>
...
<script type="text/javascript">
	var grid = $("#grid").bootgrid({
		...
		url: "/admin/site_link/list_",
		formatters: {
			"commands": function(column, row) {
				return "<a href=\"#\" class=\"btn btn-xs btn-default command-edit\" data-row-id=\"" + row.site_link_id + "\"><span class=\"fa fa-pencil\"></span></a> " +
				"<a href=\"#myModal\" role=\"button\" data-toggle=\"modal\" class=\"btn btn-xs btn-default command-delete\" data-row-id=\"" + row.site_link_id + "\"><span class=\"fa fa-trash-o\"></span></a>";
			}
		},
		converters: {
			date: {
		...
		grid.find(".command-edit").on("click", function(e) {
			loadPage("/admin/site_link/edit/id/" + $(this).data("row-id"));
	...
	$("#delete").click(function() {
		...
		$.post(
			...
			function(data) {
				...
				if (data == "success")
					loadPage("/admin/site_link/index", "delete", "success");
				else
					loadPage("/admin/site_link/index", "delete", "fail");
			}
		);
	});
</script>