...
<div class="row">
	<div class="col-xs-12">
    	<br>
		<?= form_open('/admin/kategori_peraturan/do_update', array('id' => 'form', 'role' => 'form', 'class' => 'form-horizontal')); ?>
			<input type="hidden" name="id" value="<?= $kategori_peraturan['kategori_dok_hukum_id']; ?>" />
			<div class="form-group">
				<label for="judul" class="col-sm-2 control-label">Judul</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" id="judul" name="judul" value="<?= $kategori_peraturan['judul']; ?>">
				</div>
			</div>
...
<script type="text/javascript">
	var options = {
		...
		success: function(responseText, statusText, xhr, $form) {
			$.unblockUI();
			loadPage("/admin/kategori_peraturan/index", "update", responseText);
		},
		resetForm: true
	};
