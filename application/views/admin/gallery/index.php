...
<div class="btn-toolbar list-toolbar">
    <button class="btn btn-primary" onclick="loadPage('/admin/gallery/add');"><i class="fa fa-plus"></i> Tambah</button>
...
<table id="grid" class="table table-condensed table-hover table-striped">
	<thead>
		<tr>
			<th data-column-id="gallery_id" data-header-css-class="gallery_id">ID</th>
			<th data-column-id="gallery_title" data-header-css-class="gallery_title">Judul</th>
...
<script type="text/javascript">
	var grid = $("#grid").bootgrid({
		...
		url: "/admin/gallery/list_",
		formatters: {
			"commands": function(column, row) {
				return "<a href=\"#\" class=\"btn btn-xs btn-default command-edit\" data-row-id=\"" + row.gallery_id + "\"><span class=\"fa fa-pencil\"></span></a> " +
				"<a href=\"#myModal\" role=\"button\" data-toggle=\"modal\" class=\"btn btn-xs btn-default command-delete\" data-row-id=\"" + row.gallery_id + "\"><span class=\"fa fa-trash-o\"></span></a>";
			}
		},
		converters: {
			date: {
		...
		grid.find(".command-edit").on("click", function(e) {
			loadPage("/admin/gallery/edit/id/" + $(this).data("row-id"));
	...
	$("#delete").click(function() {
		...
		$.post(
			...
			function(data) {
				...
				if (data == "success")
					loadPage("/admin/gallery/index", "delete", "success");
				else
					loadPage("/admin/gallery/index", "delete", "fail");
			}
		);
	});
</script>