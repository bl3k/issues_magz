...
<div class="btn-toolbar list-toolbar">
    <button class="btn btn-primary" onclick="loadPage('/admin/slider/add');"><i class="fa fa-plus"></i> Tambah</button>
...
<table id="grid" class="table table-condensed table-hover table-striped">
	<thead>
		<tr>
			<th data-column-id="slider_id" data-header-css-class="slider_id">ID</th>
			<th data-column-id="slider_title" data-header-css-class="slider_title">Judul</th>
			<th data-column-id="internal_link" data-header-css-class="view_counter">Link</th>
...
<script type="text/javascript">
	var grid = $("#grid").bootgrid({
		...
		url: "/admin/slider/list_",
		formatters: {
			"commands": function(column, row) {
				return "<a href=\"#\" class=\"btn btn-xs btn-default command-edit\" data-row-id=\"" + row.slider_id + "\"><span class=\"fa fa-pencil\"></span></a> " +
				"<a href=\"#myModal\" role=\"button\" data-toggle=\"modal\" class=\"btn btn-xs btn-default command-delete\" data-row-id=\"" + row.slider_id + "\"><span class=\"fa fa-trash-o\"></span></a>";
			}
		},
		converters: {
			date: {
		...
		grid.find(".command-edit").on("click", function(e) {
			loadPage("/admin/slider/edit/id/" + $(this).data("row-id"));
	...
	$("#delete").click(function() {
		...
		$.post(
			...
			function(data) {
				...
				if (data == "success")
					loadPage("/admin/slider/index", "delete", "success");
				else
					loadPage("/admin/slider/index", "delete", "fail");
			}
		);
	});
</script>