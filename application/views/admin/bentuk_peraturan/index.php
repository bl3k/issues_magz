...
<div class="header">
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Bentuk Peraturan</li>
	</ul>

</div>

<div class="btn-toolbar list-toolbar">
    <button class="btn btn-primary" onclick="loadPage('/admin/bentuk_peraturan/add');"><i class="fa fa-plus"></i> Tambah</button>
...
<table id="grid" class="table table-condensed table-hover table-striped">
	<thead>
		<tr>
			<th data-column-id="bentuk_dok_hukum_id" data-header-css-class="bentuk_dok_hukum_id">ID</th>
...
<script type="text/javascript">
	var grid = $("#grid").bootgrid({
		...
		url: "/admin/bentuk_peraturan/list_",
		formatters: {
			"commands": function(column, row) {
				return "<a href=\"#\" class=\"btn btn-xs btn-default command-edit\" data-row-id=\"" + row.bentuk_dok_hukum_id + "\"><span class=\"fa fa-pencil\"></span></a> " +
				"<a href=\"#myModal\" role=\"button\" data-toggle=\"modal\" class=\"btn btn-xs btn-default command-delete\" data-row-id=\"" + row.bentuk_dok_hukum_id + "\"><span class=\"fa fa-trash-o\"></span></a>";
			}
		},
		converters: {
			date: {
		...
		grid.find(".command-edit").on("click", function(e) {
			loadPage("/admin/bentuk_peraturan/edit/id/" + $(this).data("row-id"));
	...
	$("#delete").click(function() {
		...
		$.post(
			"/admin/bentuk_peraturan/do_delete", 
			{
				csrf_token_name: "<?= $this->security->get_csrf_hash(); ?>",
				id: $("#row_id").val()
			}, 
			function(data) {
				...
				if (data == "success")
					loadPage("/admin/bentuk_peraturan/index", "delete", "success");
				else
					loadPage("/admin/bentuk_peraturan/index", "delete", "fail");
			}
		);
	});
</script>