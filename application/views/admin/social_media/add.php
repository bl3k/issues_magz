<div class="header">
	...
	<ul class="breadcrumb">
	    ...
	    <li><a href="#" onclick="loadPage('/admin/social_media/index');">Social Media</a></li>
...
<div class="row">
	<div class="col-xs-12">
    	<br>
		<?= form_open('/admin/social_media/do_insert', array('id' => 'form', 'role' => 'form', 'class' => 'form-horizontal')); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="picasa_url" name="picasa_url">
				</div>
			</div>
...
<script type="text/javascript">
	var options = {
		...
		success: function(responseText, statusText, xhr, $form) {
			$.unblockUI();
			loadPage("/admin/social_media/index", "insert", responseText);
		},
		resetForm: true
	};
